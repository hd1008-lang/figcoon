...
export function CodeArea({ content, lang }: CodeAreaProps) {
  ...
  return (
    <div className="flex-1 min-h-0 overflow-hidden relative p-4">
      ...
      <div
        className="text-on-surface-variant text-sm leading-7 font-mono w-full h-full outline-none overflow-auto [&_pre]:bg-transparent! [&_pre]:whitespace-pre-wrap! [&_pre]:break-all! [&_.line:first-child]:hidden [&_.line:last-child]:hidden font-medium tracking-wide no-scrollbar"
